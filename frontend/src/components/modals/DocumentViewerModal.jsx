import { X, FileText, ScanText, Download, Clock3 } from 'lucide-react';

export default function DocumentViewerModal({ show, document, onClose, onPrint, onDownload, onViewHistory }) {
