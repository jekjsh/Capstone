import { Edit2, LogOut, Lock, User, Menu, ChevronDown } from 'lucide-react';
          ...
          {showProfileMenu && (
            <>
              ...
              <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-20">
                ...
                {(onEditProfile || onChangePassword) && <div className="border-t border-gray-200 my-1"></div>}
                <button
                  onClick={() => {
                    setShowProfileMenu(false);
                    onLogout();
