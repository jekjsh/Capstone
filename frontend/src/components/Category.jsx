...
export default function Category({ userOrg = null, role_type = 'user' }) {
  ...
  // Determine which pagination component to use
  const PaginationComponent = Pagination;
  
  // Get the rows to display (admin shows all, user shows paginated)
  const displayedCategories = role_type === 'admin' 
    ? categories 
    : categories.slice((currentPage - 1) * rowsPerPage, currentPage * rowsPerPage);
