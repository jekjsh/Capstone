import { FileText, Search, Eye, Trash2, User, Clock } from 'lucide-react';
import { useState } from 'react';

export default function SystemAdminDocuments({ 
  documentList = [],
  userList = [],
  onViewDocument,
  onDeleteDocument,
  ...
  const filteredDocuments = allDocuments.filter(doc => {
    ...
    // Match user by checking if filterUser is "All" or if the document's creator matches the selected user ID
